package org.jeecg.modules.demo.interfaceOption.job;
 ...
 */
@Slf4j
public class InterfaceOptionJob implements Job{
    ...
    @Override
    @TaskLog(value = "定时任务 InterfaceOptionJob")
	public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {

		log.info(String.format("welcome %s! Jeecg-Boot 带参数定时任务 InterfaceOptionJob !   时间:" + DateUtils.now(), this.parameter));
         ...
         /**
          ...
          if (parameter != null && parameter.length() > 0 && parameter.contains(";")) {
                ...
                Collection<InterfaceOption> results = interfaceOptionService.listByMap(map);
                ...
                String parentColumn = "";
                 InterfaceOption interfaceOption = (InterfaceOption) interfaceOptions.toArray()[0];
                        ...
                        for (InterfaceOption result : results) {
                         Map<String,Object> detailMap=new HashMap<>();
                         detailMap.put(StringUtils.camel2Underline("InterfaceOption")+"_id",result.getId());
                         Collection<TableOption> tableOptionList = tableOptionService.listByMap(detailMap);
                            ...
                            if (tableOption.getParentColumnName() != null) {
                                ...
                                if ("1".equals(tableOption.getFlag()) && tableOption.getDownCloumnName() != null) {//代表存在方括号
                                    ...
                                    if (downStr.contains(";") && downStr.length() > 0) {
                                        ...
                                        for (TableOption result1 : tableOptionList) {
