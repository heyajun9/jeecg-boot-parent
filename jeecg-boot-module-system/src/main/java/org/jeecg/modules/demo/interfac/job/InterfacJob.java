package org.jeecg.modules.demo.interfac.job;
 ...
 */
@Slf4j
public class InterfacJob implements Job{
    ...
    @Override
    @TaskLog(value = "定时任务 InterfacJob")
	public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {

		log.info(String.format("welcome %s! Jeecg-Boot 带参数定时任务 InterfacJob !   时间:" + DateUtils.now(), this.parameter));
         ...
         /**
          ...
          if (parameter != null && parameter.length() > 0 && parameter.contains(";")) {
                ...
                Collection<Interfac> results = interfacService.listByMap(map);
