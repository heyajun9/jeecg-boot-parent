...
public class JeecgOrderDMainController {
    ...
    @ApiOperation(value = "获取OrderMain数据列表", notes = "获取所有OrderMain数据列表")
    ...
    @ApiOperation(value = "添加OrderMain", notes = "添加OrderMain")
     ...
     */
    @PutMapping("/edit")
    @ApiOperation(value = "编辑OrderMain", notes = "编辑OrderMain")
    ...
    @ApiOperation(value = "通过ID删除OrderMain", notes = "通过ID删除OrderMain")
    ...
    @ApiOperation(value = "批量删除OrderMain", notes = "批量删除OrderMain")
    ...
    @ApiOperation(value = "通过ID查询OrderMain", notes = "通过ID查询OrderMain")
    public Result<JeecgOrderMain> queryById(@ApiParam(name = "id", value = "示例id", required = true) @RequestParam(name = "id", required = true) String id) {
        Result<JeecgOrderMain> result = new Result<JeecgOrderMain>();
        JeecgOrderMain jeecgOrderMain = jeecgOrderMainService.getById(id);
        if (jeecgOrderMain == null) {
            result.error500("未找到对应实体");
