package org.jeecg.modules.demo.wmsItemTable.job;
 ...
 */
@Slf4j
public class WmsItemTableJob implements Job{
    ...
    @Override
    @TaskLog(value = "定时任务 WmsItemTableJob")
	public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {

		log.info(String.format("welcome %s! Jeecg-Boot 带参数定时任务 WmsItemTableJob !   时间:" + DateUtils.now(), this.parameter));
         ...
         /**
          ...
          if (parameter != null && parameter.length() > 0 && parameter.contains(";")) {
                ...
                Collection<WmsItemTable> results = wmsItemTableService.listByMap(map);
                ...
                for (WmsItemTable result : results) {
                    ...
                    if (tableOption.getParentColumnName() != null) {
                        ...
                        if ("1".equals(tableOption.getFlag()) && tableOption.getDownCloumnName() != null) {//代表存在方括号
                            ...
                            if (downStr.contains(";") && downStr.length() > 0) {
                                ...
                                for (WmsItemTable result1 : results) {
